...
public class CardboardHead : MonoBehaviour {
  ...
  private void UpdateHead() {
    ...
    if (trackRotation)
    {
        ...
        //if (rot.eulerAngles.y > 90 && rot.eulerAngles.y < 270) 
        //   _isValidRotation = false;
        //else
        //   _isValidRotation = true;
        //
        //if (_isValidRotation) {
        //   Vector3 clampedRot = rot.eulerAngles;
        //   clampedRot.y = ClampAngle(rot.eulerAngles.y, 270, 90);
        //   
        //   rot.eulerAngles = clampedRot;

         Vector3 playerRot = new Vector3(0, rot.eulerAngles.y, 0);
        Vector3 camRot = new Vector3(rot.eulerAngles.x, 0, 0);
        rot.eulerAngles = camRot;
        if (target == null)
        {
            //transform.localRotation = rot;
            _playerObj.eulerAngles = playerRot;
            transform.localRotation = rot;
        }
        else
        {
